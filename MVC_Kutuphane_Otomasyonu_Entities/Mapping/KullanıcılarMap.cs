...
{
    public class KullanıcılarMap : EntityTypeConfiguration<Kullanicilar>
    {
        public KullanıcılarMap()
        {
            this.ToTable("Kullanicilar");//Table Adı
            ...
            this.Property(x => x.Sifre).IsRequired().HasMaxLength(100);
